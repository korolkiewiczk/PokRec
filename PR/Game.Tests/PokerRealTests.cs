...
public class PokerRealTests : PokerTestsBase
{
    public PokerRealTests(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
    {
    ...
    public void Player_SB_Solve_ShouldInferActionsProperly_WhenSteppingThroughPhases()
    {
        ...
        var gameActions = poker.GameActions;//.Where(x=>(int)x.ActionType>(int)PokerActionType.Check);
